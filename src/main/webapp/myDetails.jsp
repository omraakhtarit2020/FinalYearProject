...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-white bg-dark">
		<img src="TINT.jpg" width="40" height="40" alt="">
		...
		<div class="collapse navbar-collapse  container-fluid"
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a
					class="nav-link text-white bg-dark" href="help.html">Help <span
						class="sr-only"></span></a></li>
			</ul>

			<span class="form-inline my-2 my-lg-0">

				<p class="text-white bg-dark mb-0" id="uname"></p>
				&nbsp;&nbsp;&nbsp;
	...
	<div class="container"
		style="border: 2px solid green; margin-top: 20px">
		<span style="text-align: center;"><h3>My Details</h3></span> <br>
		<div class="container" style="border: 2px solid rgb(238, 226, 220);">
			<div class="container" style="border: 2px solid rgb(238, 226, 220);">
				<div class="container" style="border: 2px solid rgb(238, 226, 220);">
					<div class="container"
						style="border: 2px solid rgb(238, 226, 220);">
						<div class="container"
							style="border: 2px solid rgb(238, 226, 220);">
							<form action="myDetailsServlet" method="post">
								<label for="txtName" class="form-label "><h4
										class='asterik'>Name :</h4></label>
								<div class="row w-100 p-3">
									<div class="col">
										<input onkeyup="nCheck()" type="text" maxlength="20"
								...
								<div class="text-danger" id="nError" style="display: none">please
									enter a valid Name</div>
								<div class="text-danger" id="nError1" style="display: none">This
									field is mandatory</div>
								<br> <label for="email" class="form-label"><h4
										class='asterik'>Email :</h4></label>
								<div class="row">
									<div class="col">
										<input type="email" type="text" name="email"
											class="form-control" id="mail-value" value='' readonly />
									</div>
									<br> <br>
									...
									<div class="mb-3 row">
										...
										<label for="txtName" class="form-label "><h4
												class='asterik'>Designation :</h4></label>
										<div class="col cow-100 p-3">
											<select onchange="desgCheck()" class="form-select"
												name="designation" id="desg"
												...
												<option value="Assistant  Professor">Assistant
													Professor</option>
												<option value="Technical  Professor">Technical
													Professor</option>
											</select>
										</div>
										<div class="text-danger" id="desgError" style="display: none">This
											field is mandatory</div>
										<br>
									</div>
									<br>
									...
									<div class="mb-3 row">
										<label for="txtName" class="form-label "><h4
												class='asterik'>Subject :</h4></label>
										<div class="col w-100 p-3">
											<select onchange="subCheck()" class="form-select"
												name="subject" id="sub" aria-label="Default select example ">
												<option selected value="">Open this select menu</option>
												<option value="Mechanical Engineering (ME)">Mechanical
													Engineering (ME)</option>
												<option value="Civil Engineering (CE)">Civil
													Engineering (CE)</option>
												<option
													value="Electronics and Communications Engineering (ECE)">Electronics
													and Communications Engineering (ECE)</option>
												<option value="Computer Science Engineering (CSE)">Computer
													Science Engineering (CSE)</option>
												<option value="Electrical Engineering (EE)">Electrical
													Engineering (EE)</option>
												<option value="Information Technology (IT)">Information
													Technology (IT)</option>
												<option
													value="Applied Electronics & Instrumentation Engineering (AEIE)">Applied
													Electronics & Instrumentation Engineering (AEIE)</option>
												<option value="Bachelor of Business Education (BBE)">
													Bachelor of Business Education (BBE)</option>
												<option value="Bachelors's of Computer Application (BCA)">Bachelors's
													of Computer Application (BCA)</option>
												<option value="Masters of Computer Applications">Masters
													of Computer Applications</option>
												<option value="AI-ML">AI-ML</option>
												<option value="CSBS">CSBS</option>
											</select>
										</div>
										<div class="text-danger" id="subError" style="display: none">This
											field is mandatory</div>
										<br>
									</div>
									<br>
									...
									<div class="mb-3 row">
										<label for="txtName" class="form-label "><h4
												class='asterik'>Highest Qualification :</h4></label>
										<div class="w-100 p-3">
											<select onchange="hqCheck()" class="form-select" name="HQ"
												id="hq" aria-label="Default select example ">
												<option selected value="">Open this select menu</option>
												<option value="10th">10th</option>
												<option value="12th">12th</option>
												<option value="Diploma">Diploma</option>
												<option value="Bachelor of Technology (B.Tech)">Bachelor
													of Technology (B.Tech)</option>
												<option value="Master of Technology (M.Tech)">Master
													of Technology (M.Tech)</option>
											</select>
										</div>
										<div class="text-danger" id="hqError" style="display: none">This
											field is mandatory</div>
										<br>
									</div>
									...
									<div class="mb-3 row">
										<label for="txtName" class="form-label "><b><h4>Any
													Other :</h4></b></label>
										<div class="col w-100 p-3">
											<input type="text" class="form-control" name="other"
												placeholder="Others..." aria-label="Any Other">
										</div>
										<br> <br> <label for="txtName"
											class="form-label col-form-label"><b><h4>Teaching
													Exp (in years) :</h4></b></label>
										<div class="col w-100 p-3">
											<input type="text" class="form-control" name="tExp" id="exp"
												placeholder="Exp...." aria-label="Exp">
										</div>
										<br>
									</div>
									...
									<div class="col">
										<div class="multiselect w-100 p-3">
											...
											<div id="checkboxesTM">
												<label for="oneTM"> <input onchange="TMcheck()"
													type="checkbox" id="oneTM" name="teachingMethods"
													value="Lecture" />Lecture
												</label> <label for="twoTM"> <input onchange="TMcheck()"
													type="checkbox" id="twoTM" name="teachingMethods"
													value="Workshop" />Workshop
												</label> <label for="threeTM"> <input onchange="TMcheck()"
													type="checkbox" id="threeTM" name="teachingMethods"
													value="Field Trip" />Field Trip
												</label> <label for="fourTM"> <input onchange="TMcheck()"
													type="checkbox" id="fourTM" name="teachingMethods"
													value="Project" />Project
												</label>
											</div>
										</div>
									</div>
									<div class="text-danger" id="TMError" style="display: none">This
										field is mandatory</div>
									<br> <label for="txtName" class="form-label "><h4
											class='asterik'>Technology Used :</h4></label>
									<div class="w-100 p-3">
										<div class="multiselect w-100 p-3">
											<div class="selectBox" onclick="showCheckboxes()">
												<select class="form-select" name="tUsed"
													aria-label="Default select example ">
													<option>Open this select menu</option>
												</select>
												<div class="overSelect"></div>
											...
											<div id="checkboxes">
												<label for="one"> <input onchange="TUcheck()"
													type="checkbox" id="one" name="technologyUsed"
													value="Chalk Board" />Chalk Board
												</label> <label for="two"> <input onchange="TUcheck()"
													type="checkbox" id="two" name="technologyUsed"
													value="White Board" />White Board
												</label> <label for="three"> <input onchange="TUcheck()"
													type="checkbox" id="three" name="technologyUsed"
													value="Projector" />Projector
												</label>
											</div>
										</div>
									</div>
									<div class="text-danger" id="TUError" style="display: none">This
										field is mandatory</div>
									<br>

									<div class="mb-3 row">
										<label for="txtName" class="form-label "><h4
												class='asterik'>Study Material Developed:</h4></label>
										<div class="col w-100 p-3">
											<select onchange="SMDCheck()" class="form-select" name="SMD"
												id="SMD" aria-label="Default select example ">
												<option selected value="">Open this select menu</option>
												<option value="Yes">Yes</option>
												<option value="No">No</option>
											</select>
										</div>
										<div class="text-danger" id="SMDError" style="display: none">This
											field is mandatory</div>
										<br>
									...
									<label for="txtName" class="form-label"><h4
											class='asterik'>Contribution to enrich quality of
											teaching:</h4></label>
									<div class="d-flex p-2">
										<div class="multiselect w-100 p-3">
											<div class="selectBox" onclick="showCheckboxes1()">
												<select class="form-select" name="CEQT"
													aria-label="Default select example ">
													<option>Open this select menu</option>
												</select>
												<div class="overSelect"></div>
											...
											<div id="checkboxes1">
												<label for="one1"> <input onchange="CEQcheck()"
													type="checkbox" id="one1" name="contribution"
													value="Seminars" />Seminars
												</label> <label for="two1"> <input onchange="CEQcheck()"
													type="checkbox" id="two1" name="contribution"
													value="Workshop" />Workshop
												</label> <label for="three1"> <input onchange="CEQcheck()"
													type="checkbox" id="three1" name="contribution"
													value="Lecture" />Lecture
												</label> <label for="four1"> <input onchange="CEQcheck()"
													type="checkbox" id="four1" name="contribution"
													value="Field Visit" />Field Visit
												</label>
											</div>
										</div>
									</div>
									<div class="text-danger" id="CEQError" style="display: none">This
										field is mandatory</div>
									<br> <br> <br> <br>
	...
	<script type="text/javascript">
            ...
            function check(){
            	if(fName.value=="" || desg.value=="" || sub.value=="" || hq.value=="" || SMD.value==""){
            		submit.disabled=true;
            	}
            	if(oneTM.checked==false && twoTM.checked==false && threeTM.checked==false && fourTM.checked==false){
            		submit.disabled=true;
            	}
            	if(one.checked==false && two.checked==false && three.checked==false){
            		submit.disabled=true;
            	}
            	if(one1.checked==false && two1.checked==false && three1.checked==false && four1.checked==false){
            		submit.disabled=true;
            	}
            	//console.log(1)
            }
