                        ...
                        <div class="container" style="border: 2px solid rgb(238, 226, 220);">
                            <div class="container" style="border: 2px solid rgb(238, 226, 220);">
                               	...
                               	<form action="myDetailsServlet" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="email"  type="text"  name="email" class="form-control" id="mail-value" name="uName" readonly  />
                                        </div>
                                        <br>
                                        <br>
                                        <br>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="email"  type="text"  class="form-control" id="mail-value" name="aName" />
                                        </div>
                                        <br>
                                        <br>
                                        <br>
