   ...
   <div class="container my-5">
  		<div class="row justify-content-md-center">
    		...
    		<div class="col-md-auto">
      			<button type="button" onclick="addNewField()" class="btn btn-success mt-4 margl" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border-radius: 10px">Add New Field in the table Publsihed Books<b>&nbsp;+</b></button>
    		</div>
