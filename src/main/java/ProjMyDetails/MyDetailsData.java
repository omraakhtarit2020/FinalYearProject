...
public class MyDetailsData {
	private String fName, mName, lName, uName, aName, phn, udob, tcsionId, designation, subject, highestQualification,
			anyOther, teachingExp, teachingMethods, technologyUses, smd, ceqt;

	public MyDetailsData() {
		super();
	}

	public MyDetailsData(String fName, String mName, String lName, String uName, String aName, String phn, String udob,
			String tcsionId, String designation, String subject, String highestQualification, String anyOther,
			String teachingExp, String teachingMethods, String technologyUses, String smd, String ceqt) {
		super();
		this.fName = fName;
		this.mName = mName;
		this.lName = lName;
	...
	public String getTcsionId() {
		return tcsionId;
	}

	public void setTcsionId(String tcsionId) {
		this.tcsionId = tcsionId;
	}
