...
//import StaffInformation.myDetailsDaw;
...
public class myDetailsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(fName+' '+mName+' '+lName+' '+designation+' '+subject+' '+highestQualification+' '+anyOther+' '+teachingExp+' '+teachingMethods+' '+technologyUses+' '+smd+' '+ceqt+' '+uName);
		MyDetailsData myDetailsData = new MyDetailsData(fName,mName,lName,uName,designation,subject,highestQualification,anyOther,teachingExp,teachingMethods,technologyUses,smd,ceqt);
